...
export default function imgFundo (props){
    ...
    <div  className="relative grid justify-items-center  ">
       ...
       <p className="bottom-24 absolute mx-5 left-4"> Lorem is totam non quam, vel deleniti consequatur minus architecto laudantium inventore omnis eum soluta consectetur? Modi nobis enim consequatur!  </p>
